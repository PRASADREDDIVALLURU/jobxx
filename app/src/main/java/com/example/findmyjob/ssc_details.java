...
public class ssc_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssc_details);
        ...
        auth.signInWithEmailAndPassword(email, pwd1).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(ssc_details.this, "Date saved", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ssc_details.this, Educationdetails.class));
                    finish();
                } else {
                    Toast.makeText(ssc_details.this, "DATA NOT SAVED", Toast.LENGTH_SHORT).show();
                }
            }
        });
